...
//skiplinks
$skiplinks-color: $primary-a12 !default;
$skiplinks-bg: $analogue-2-b1 !default;
...
$breadcrumb-link-color: $neutral-1-a7 !default;
...
// Inputs
$input-border: $gray-200 !default;
$input-label-color: $neutral-1-a8 !default;
...
$navigation-light-megamenu-footer-bg-color: $primary-a7 !default;
$navigation-light-separator-color: $neutral-1-a2 !default;
$navigation-light-megamenu-separator-color: $primary-c5 !default;
...
$megamenu-footer-bg-color: $lightgrey-c2 !default;
...
$pager-font-color: $neutral-1-a7 !default;
$pager-hover-color: $primary !default;
$pager-icon-color: $primary !default;
$pager-icon-size: 0.7rem;
$pager-disabled-color: $neutral-2-b2 !default;
$pager-jump-to-width: 4.5rem;
$pager-jump-to-color: $neutral-2-b3 !default;
...
$sidebar-border-color: $neutral-1-a2 !default;
...
$navscroll-secondary-active-color: $neutral-1-a10 !default;
$navscroll-links-padding: 0.8em;
$navscroll-bg-color-desk: $white !default;
$navscroll-line-color: $neutral-1-a2 !default;
...
$header-slim-bg-color: $primary-a11 !default;
...
$header-slim-theme-light-text-color: $primary-a7 !default;
$header-slim-theme-light-button-color: $primary !default;
$header-slim-theme-light-button-hover-color: $primary-a6 !default;
...
$card-h5-fw: 700;
$card-h5-color: $neutral-1-a10 !default;
$card-p-size: 0.875rem;
$card-p-size-desk: 0.7777777777777778rem;
$card-p-l-h: 1.2rem;
$card-p-color: $neutral-1-a8 !default;
$card-border-color: $neutral-1-a2 !default;
...
$card-link-color: $primary-a9 !default;
...
// flag icon
$flag-icon-color: $primary-a6 !default;
$flag-icon-h: $v-gap * 6;
$flag-icon-w: $v-gap * 4;
// tag
$tag-radius: 50px;
...
$select-label-color: $neutral-1-a8 !default;
...
$select-dd-link-color-active: $neutral-1-a10 !default;
$select-dd-small-separator-width: 65px;
$select-dd-small-separator-bg: $neutral-1-a1 !default;
...
//date picker
$dp-label-color: $neutral-1-a8 !default;
...
//hero
$hero-bg-color: $primary-a6 !default;
...
$hero-primary-bg: rgba($primary-a6, 0.85) !default;
...
$crs-dots-color: $primary-a7 !default;
...
$grid-item-text-color: $neutral-1-a8 !default;
...
$list-border-color: $neutral-1-a3 !default;
$list-metadata-color: $neutral-1-a7 !default;
$list-metadata-size: 12px;
$list-metadata-space: 0.5px;
$list-sub-size: 14px;
$list-sub-color: $neutral-1-a8 !default;

//chips
$chips-background: #fcfdff !default;
$chips-background-hover: #8b98a6 !default;
$chips-label-color: $gray-secondary !default;
$chips-label-color-disabled: $neutral-1-a7 !default;
...
$timeline-border-color: linear-gradient(0deg, $primary 0%, #004080 100%) !default;
